  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box component="img" src={logoSrc} alt="InterTech Americas" sx={{ height: 52, width: 'auto', position: 'relative' }} />
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', p: { xs: '40px 24px', md: '40px 24px' } }}>
        <Box sx={{ width: '100%', maxWidth: 400 }}>
          <Box sx={{ display: { xs: 'block', md: 'none' }, mb: 2 }}>
            <Box component="img" src={logoSrc} alt="InterTech Americas" sx={{ height: 46 }} />
          </Box>
          {children}
        </Box>
      </Box>
